...
st.subheader("AE")
st.markdown(""" This app optimizes a given portfolio using variable optimization techniques. Enter stock tickers, initial allocations, historical data range, and finally the desired optimization criterion to get started.""")
st.markdown("""
